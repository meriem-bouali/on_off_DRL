...
if __name__ == "__main__":
    TestOffRL8e6Clean(model_name="DoubleDQN_lr_0.0001_OffRL8e6Clean_model.pack", seed=SC.seed_test, max_episodes=len(SC.seed_test),seed_category="seed_test").run()
    
    TestOffRL8e6Clean(model_name="DoubleDQN_lr_0.0001_OffRL8e6Clean_model.pack", seed=SC.seed_train, max_episodes=len(SC.seed_train),seed_category="seed_train").run()
