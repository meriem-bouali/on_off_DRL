...
class TestOffRL4e6Cleanshuffle:
    def __init__(self, model_name: str, seed: list, max_episodes: int,seed_category:str, gui: bool = False):
        ...
        self.policy = "OffRL4e6CleanShuffle"
        self.mode = "test"
...
if __name__ == "__main__":
    TestOffRL4e6Cleanshuffle(
        model_name="DoubleDQN_lr_0.0001_OffRL4e6CleanShuffle_model.pack", seed=SC.seed_test, max_episodes=len(SC.seed_test),seed_category="seed_test"
    ).run()


    TestOffRL4e6Cleanshuffle(
        model_name="DoubleDQN_lr_0.0001_OffRL4e6CleanShuffle_model.pack", seed=SC.seed_train, max_episodes=len(SC.seed_train),seed_category="seed_train"
    ).run()