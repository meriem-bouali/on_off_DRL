...
if __name__ == "__main__":
    TestBCQ4e6(
        model_name="BCQ_lr_0.0001_BCQ4e6_model.pack", seed=SC.seed_test, max_episodes=len(SC.seed_test),seed_category="seed_test"
    ).run()
    
    TestBCQ4e6(
        model_name="BCQ_lr_0.0001_BCQ4e6_model.pack", seed=SC.seed_train, max_episodes=len(SC.seed_train),seed_category="seed_train"
    ).run()
