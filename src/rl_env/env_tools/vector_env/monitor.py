...
## Source: https://github.com/openai/baselines/blob/master/baselines/bench/monitor.py
# * - A monitor wrapper for Gym environments, used for tracking and recording episode statistics :
# *   episode reward, length, time and other data
