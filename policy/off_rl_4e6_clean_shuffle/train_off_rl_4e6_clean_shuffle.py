...
class TrainOffRL4e6Cleanshuffle:
    def __init__(self, csv_dir_path, algo=HYPER_PARAMS.algo + "Off", max_total_iteration=HYPER_PARAMS.nb_total_iteration):
...
if __name__ == "__main__":
    TrainOffRL4e6Cleanshuffle(csv_dir_path="transition_csv_DoubleDQN_OnRL_16e6_cleaned", max_total_iteration=HYPER_PARAMS.nb_total_iteration).run()
