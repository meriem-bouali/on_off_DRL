...
if __name__ == "__main__":
    TrainBCQ4e6Cleanshuffle(csv_dir_path="transition_csv_DoubleDQN_OnRL_16e6_cleaned", max_total_iteration=HYPER_PARAMS.nb_total_iteration).run()
